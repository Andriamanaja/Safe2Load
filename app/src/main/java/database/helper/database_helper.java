...
public class database_helper extends SQLiteOpenHelper {
    ...
    private static final String categorie = "create table if not exists categorie (categorie_id integer not null primary key autoincrement, categorie_nom varchar(20))" ;
    private static final String depot = "create table if not exists depot (depot_id integer not null primary key autoincrement, depot_nom  varchar(100), depot_reference  varchar(100))" ;
    ...
    private static final String typeoperation = "create table if not exists typeoperation (typeoperation_id integer not null primary key autoincrement, typeoperation_nom varchar(250))" ;
    ...
    private static final String vehicule = "create table if not exists vehicule (vehicule_id integer not null primary key autoincrement, vehiculetype_id integer, uacc_id integer, vehicule_immatriculation varchar(50), vehicule_ptra numeric, vehicule_ptac numeric, vehicule_poidsvide numeric, vehicule_anneefabrication numeric, vehicule_obc tinyint(1), vehicule_marqueobc varchar(50)) " ;
