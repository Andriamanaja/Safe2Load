...
public class database_helper extends SQLiteOpenHelper {
    ...
    //private static final String inspectionvehicule = "create table if not exists inspectionvehicule (vehicule_id integer not null, inspection_id integer not null)" ;
